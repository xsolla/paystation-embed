...
Script is located on our CDN and is available here: [https://cdn.xsolla.net/payments-bucket-prod/embed/1.5.3/widget.min.js](https://cdn.xsolla.net/payments-bucket-prod/embed/1.5.1/widget.min.js). Use this URL to integrate script on your website.
